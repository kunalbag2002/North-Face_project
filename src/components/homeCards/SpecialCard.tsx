...
import card5 from '/public/images/tab2.avif'
import card8 from '/public/images/tab3.avif'
import card7 from '/public/images/tab4.avif'
import card6 from '/public/images/tab56.avif'
